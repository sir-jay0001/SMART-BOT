...
module.exports = {
    ...
    OWNER_NAME: process.env.OWNER_NAME || "Sir Jay",
    OWNER_NUMBER: process.env.OWNER_NUMBER || "",
    BOT: process.env.BOT_NAME || 'SMART_BOT',
    URL: process.env.BOT_MENU_LINKS || 'https://files.catbox.moe/h2ydge.jpg',
    SMART_BOT: hybridConfig.buildContentLayer(),
    ...
    FOOTER: process.env.BOT_FOOTER || '\n\nFor more info message me: +254794597254\n\n®2025 SMART BOT 🔥',
    DATABASE_URL,
