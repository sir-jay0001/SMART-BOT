...
const BOT_NAME = "SMART-BOT";
const DEFAULT_THUMBNAIL = "https://files.catbox.moe/h0ev4n.png";
...
const createContext = (userJid, options = {}) => ({
    contextInfo: {
        ...
        externalAdReply: {
            ...
            sourceUrl: options.sourceUrl || "https://wa.me/254794597254", // link to bot or business
